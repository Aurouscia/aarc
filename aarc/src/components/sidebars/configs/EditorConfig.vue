...
const { staNameFob, lineFob, staFob, duplicateNameDistThrs, allowMergePtAndTerrain, ignoreStyleAndSpan, staNameSnapDiagonal, gridLabelSize } = storeToRefs(configStore)
        ...
        <tr>
            <td>
                ...
                <div>
                    ...
                    <button class="minor" @click="staFob = 3">宽松</button>
                </div>
                <div class="explain">
