...
export const KICK_IDLE_THRESHOLD_MS = 10 * MINUTE_MS
export const KICK_INFO_REFRESH_MS = 30 * SECOND_MS

export const SAVE_REMINDER_INTERVAL_MS = 10 * MINUTE_MS
export const SAVE_REMINDER_EARLY_MS = 1 * MINUTE_MS
