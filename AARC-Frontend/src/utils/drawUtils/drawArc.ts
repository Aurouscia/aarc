...
export function drawArcByThreePoints(ctx:CanvasRenderingContext2D, a:Coord, b:Coord, c:Coord){
...
export function drawArcByTwoRays(ctx:CanvasRenderingContext2D, a:FormalRay, b:FormalRay, radius?:number){
