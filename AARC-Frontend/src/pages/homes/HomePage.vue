...
<div class="releaseNotes">
    <Notice :type="'info'" :title="'2025-6-3更新'">
        1. 可全局/个体编辑各种标签的锚点位置、文本对齐等选项<br/>
        2. 可全局/个体编辑线路标签的宽度、是否数字放大<br/>
        3. 可编辑地形节点的坐标（悬浮菜单中添加“打开设置”按钮）<br/>
        4. 修复“移动车站到左上角删除”后的异常情况<br/>
        5. （6-2）添加“编辑器-站名糊弄机制”设置选项（性能优化）如果感觉不爽可以关掉，感觉爽可以尝试开更大
    </Notice>
